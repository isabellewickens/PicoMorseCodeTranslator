# Morse Code Input System – Raspberry Pi Pico
...
- GPIO Control and analog input handling.
- Circuit design, implementation and hardware debugging.
- Team collaboration, communication & task management.
